...
public class JwtUtilTest {
  ...
  private static String mockExpiredToken;
  ...
  public void expiredTokenTest() {
    AccessTokenExpiredException accessTokenExpiredException =
        assertThrows(
            AccessTokenExpiredException.class, () -> jwtUtil.isTokenValid(mockExpiredToken));
  ...
  public void getUserNameFromTokenTest() {
    String userNameFromToken = jwtUtil.getUserNameFromToken(mockExpiredToken);
  ...
  public void getTokenFromHeaderTest() {
    ...
    request.addHeader("Authorization", "Bearer " + mockExpiredToken);
    String accessToken = jwtUtil.getTokenFromHeader(request);
    assertEquals(accessToken, mockExpiredToken);
  }
