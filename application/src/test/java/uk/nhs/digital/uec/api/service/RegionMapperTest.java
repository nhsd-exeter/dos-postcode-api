...
public class RegionMapperTest {
  ...
  public void setup() {
    ...
    regionRecords.add(new RegionRecord("EX8", "subregion8", new String[] {"EX8","EX9"}, "Yorkshire"));
    regionRecords.add(new RegionRecord("FX88", "subregion88", new String[] {"FX88","FX89"}, "london"));
    regionRecords.add(new RegionRecord("GX7", "subregion7", new String[] {"GX77","GX78"}, "east of england"));
    regionRecords.add(new RegionRecord("HX6", "subregion9", new String[] {"HX66","HX67"}, "west midlands"));
    regionRecords.add(new RegionRecord("IX56", "subregion10", new String[] {"IX56","IX57"}, "east midlands"));
    regionRecords.add(new RegionRecord("JX78", "subregion11", new String[] {"JX78","JX79"}, "north west"));
    regionRecords.add(new RegionRecord("KX86", "subregion12", new String[] {"KX86","KX87"}, "south west"));
    regionRecords.add(new RegionRecord("LX96", "subregion13", new String[] {"LX96","LX97"}, "south east"));
    ...
    ccgList = List.of(
      ...
      icbRecordList = List.of(
        new ICBRecord("X2C4Y","X2C4Y Region","X2C4Y ICB","X2C4Y@nhs.net"),
        new ICBRecord("01H","01H Region","01H ICB","01H@nhs.net"),
        new ICBRecord("06L","06L Region","06L ICB","06L@nhs.net"),
        new ICBRecord("M1J4Y","M1J4Y Region","M1J4Y ICB","M1J4Y@nhs.net"),
        new ICBRecord("M1JY","M1JY Region","M1JY ICB","M1JY@nhs.net"),
        new ICBRecord("MJ4Y","MJ4Y Region","MJ4Y ICB","MJ4Y@nhs.net"),
        new ICBRecord("M1JY","M1JY Region","M1JY ICB","M1JY@nhs.net"),
        new ICBRecord("1J4Y","1J4Y Region","1J4Y ICB","1J4Y@nhs.net"),
        new ICBRecord("XXXXX","XXXXX Region","XXXXX ICB","XXXXX@nhs.net")
      );
  ...
  public void getICBRecordTest() throws IOException, ExecutionException, InterruptedException {
    ...
    ICBRecord expected = ICBRecord.builder()
    .email("06L@nhs.net")
    .nhsIcb("06L ICB")
  ...
  @Test
  public void getCCGRecordTest() throws IOException, ExecutionException, InterruptedException {
    // Given
  ...
  @Test
  public void getCCGRecordNullTest() throws IOException, ExecutionException, InterruptedException {
    // Given
    Future<List<CCGRecord>> fut = mock(Future.class);
    when(executorService.submit(any(Callable.class))).thenReturn(fut);
    when(fut.get()).thenReturn(ccgList);
  ...
  @Test
  public void getCCGRecordKnownPostCodeAndUnknownRegion() throws IOException, ExecutionException, InterruptedException {
    // Given
    Future<List<CCGRecord>> fut = mock(Future.class);
    when(executorService.submit(any(Callable.class))).thenReturn(fut);
    when(fut.get()).thenReturn(ccgList);
