...
public class PostcodeMappingController {
    ...
    @GetMapping()
    public ResponseEntity<List<PostcodeMapping>> getPostcodeMapping(@RequestParam(name = "postcodes", required = false) List<String> postCodes,
    ...
    @GetMapping("/all")
    public ResponseEntity<List<PostcodeMapping>> getAllPostcodeMappings(@RequestParam(name = "postcodes", required = false) List<String> postCodes,
            @RequestParam(name = "name", required = false) String name) throws InvalidPostcodeException {
