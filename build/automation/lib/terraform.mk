...
terraform-import-stack:
	...
	make docker-run-terraform DIR="$(TERRAFORM_DIR)/$(STACK)" CMD="import aws_wafv2_web_acl.waf_acl 70b41dd7-7c93-49f4-b9a1-4e7d0c6f4a3a/uec-sf-pc-pd-waf-acl/REGIONAL"
